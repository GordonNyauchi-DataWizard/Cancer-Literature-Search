...
def can_ask_question():
    ...
    # Check limit
    DAILY_LIMIT = 1  # Change this number to allow more questions per day
...
def main():
    ...
    with col1:
        ...
        # Question Answering mode (WITH LIMITS)
            ...
            st.markdown(
                "Ask questions and get AI-generated answers based on the research papers. **Limited to 1 question per day.**"
            )
        ...
        # Comparative Analysis mode (WITH LIMITS)
            ...
            st.markdown(
                "Compare findings across multiple papers on a topic. **Limited to 1 analysis per day.**"
            )
    ...
    with col2:
        ...
        st.markdown(
            ...
            - **Q&A is limited**: 1 per day to control costs
